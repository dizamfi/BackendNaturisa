...
const { arregloTagsPS15Antenas, generarTags, generarTagsTCP } = require('../../../helpers/camaron/arregloTagsAireacion');
...
const getPS15 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Camaron_FCAM_PS15'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS15TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Camaron_FCAM_PS15_TA_15_01','Camaron_FCAM_PS15_TA_15_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS15 = (ws, message) => {
    if (message.toString() === 'subscribeFCAMPS15'){
    ...
    } else if (message.toString() === 'unsubscribeFCAMPS15'){

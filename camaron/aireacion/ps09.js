...
const { arregloTagsPS09Antenas, generarTags, generarTagsTCP } = require('../../../helpers/camaron/arregloTagsAireacion');
...
const getPS09 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Camaron_FCAM_PS09'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS09TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Camaron_FCAM_PS09_TA_09_01','Camaron_FCAM_PS09_TA_09_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS09 = (ws, message) => {
    if (message.toString() === 'subscribeFCAMPS09'){
    ...
    } else if (message.toString() === 'unsubscribeFCAMPS09'){

...
const { arregloTagsPS02Antenas, generarTags, generarTagsTCP } = require('../../../helpers/camaron/arregloTagsAireacion');
...
const getPS02 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Camaron_FCAM_PS02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS02TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Camaron_FCAM_PS02_TA_02_01','Camaron_FCAM_PS02_TA_02_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS02 = (ws, message) => {
    if (message.toString() === 'subscribeFCAMPS02'){
    ...
    } else if (message.toString() === 'unsubscribeFCAMPS02'){

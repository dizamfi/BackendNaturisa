...
const { generarTags, generarTagsTCP, arregloTagsPS47Antenas } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const getPS47 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Josefina_FJOS_PS47'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS47TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Josefina_FJOS_PS47_TA_47_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS47 = (ws, message) => {
    if (message.toString() === 'subscribeFJOSPS47'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSPS47'){

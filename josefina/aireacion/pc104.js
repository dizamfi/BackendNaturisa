...
const { generarTags, generarTagsTCP, arregloTagsPC104Antenas } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const getPC104 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Josefina_FJOS_PC104'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPC104TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Josefina_FJOS_PC104_TA_104_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPC104 = (ws, message) => {
    if (message.toString() === 'subscribeFJOSPC104'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSPC104'){

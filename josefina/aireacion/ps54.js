...
const { generarTags, generarTagsTCP, arregloTagsPS54Antenas } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const getPS54 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Josefina_FJOS_PS54'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS54TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Josefina_FJOS_PS54_TA_54_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS54 = (ws, message) => {
    if (message.toString() === 'subscribeFJOSPS54'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSPS54'){

...
const { generarTags, generarTagsTCP, arregloTagsPS23Antenas } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const getPS23 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Josefina_FJOS_PS23'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS23TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Josefina_FJOS_PS23_TA_23_01','Josefina_FJOS_PS23_TA_23_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS23 = (ws, message) => {
    if (message.toString() === 'subscribeFJOSPS23'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSPS23'){

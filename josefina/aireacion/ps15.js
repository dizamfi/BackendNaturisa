...
const { generarTags, generarTagsTCP, arregloTagsPS15Antenas } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const getPS15 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Josefina_FJOS_PS15'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS15TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Josefina_FJOS_PS15_TA_15_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS15 = (ws, message) => {
    if (message.toString() === 'subscribeFJOSPS15'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSPS15'){

...
const { arregloTagsAntenasAllJosefina } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const handleSubscriptionAntenasAllJosefina = (ws, message) => {
    if (message.toString() === 'subscribeFJOSAntenas'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSAntenas'){
...
module.exports = { handleSubscriptionAntenasAllJosefina }

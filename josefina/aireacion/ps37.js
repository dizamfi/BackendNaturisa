...
const { generarTags, generarTagsTCP, arregloTagsPS37Antenas } = require('../../../helpers/josefina/arregloTagsAireacion');
...
const getPS37 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Josefina_FJOS_PS37'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS37TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Josefina_FJOS_PS37_TA_37_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS37 = (ws, message) => {
    if (message.toString() === 'subscribeFJOSPS37'){
    ...
    } else if (message.toString() === 'unsubscribeFJOSPS37'){

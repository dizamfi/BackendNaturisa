...
const { generarTags, generarTagsTCP, arregloTagsPS49Antenas } = require('../../helpers/pesjolla/arregloTagsAireacion');
...
const getPS49 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Pesjolla_FPSJ_PS49'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS49TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Pesjolla_FPSJ_PS49_TA_49_01','Pesjolla_FPSJ_PS49_TA_49_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS49 = (ws, message) => {
    if (message.toString() === 'subscribeFPSJPS49'){
    ...
    } else if (message.toString() === 'unsubscribeFPSJPS49'){

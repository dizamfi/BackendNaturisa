...
const { generarTags, generarTagsTCP, arregloTagsPS47BAntenas } = require('../../helpers/pesjolla/arregloTagsAireacion');
...
const getPS47B = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Pesjolla_FPSJ_PS47B'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS47BTCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Pesjolla_FPSJ_PS47B_TA_47B_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS47B = (ws, message) => {
    if (message.toString() === 'subscribeFPSJPS47B'){
    ...
    } else if (message.toString() === 'unsubscribeFPSJPS47B'){

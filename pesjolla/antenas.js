...
const { arregloTagsAntenasAllPesjolla } = require('../../helpers/pesjolla/arregloTagsAireacion');
...
const handleSubscriptionAntenasAllPesjolla = (ws, message) => {
    if (message.toString() === 'subscribeFPSJAntenas'){
    ...
    } else if (message.toString() === 'unsubscribeFPSJAntenas'){
...
module.exports = { handleSubscriptionAntenasAllPesjolla }

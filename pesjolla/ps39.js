...
const { generarTags, generarTagsTCP, arregloTagsPS39Antenas } = require('../../helpers/pesjolla/arregloTagsAireacion');
...
const getPS39 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Pesjolla_FPSJ_PS39'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS39TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Pesjolla_FPSJ_PS39_TA_39_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS39 = (ws, message) => {
    if (message.toString() === 'subscribeFPSJPS39'){
    ...
    } else if (message.toString() === 'unsubscribeFPSJPS39'){

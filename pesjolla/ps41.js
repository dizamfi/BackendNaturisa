...
const { generarTags, generarTagsTCP, arregloTagsPS41Antenas } = require('../../helpers/pesjolla/arregloTagsAireacion');
...
const getPS41 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Pesjolla_FPSJ_PS41'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS41TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Pesjolla_FPSJ_PS41_TA_41_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS41 = (ws, message) => {
    if (message.toString() === 'subscribeFPSJPS41'){
    ...
    } else if (message.toString() === 'unsubscribeFPSJPS41'){

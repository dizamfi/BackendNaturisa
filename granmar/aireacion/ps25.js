...
const { generarTags, generarTagsTCP, arregloTagsPS25Antenas } = require('../../../helpers/granmar/arregloTagsAireacion');
...
const getPS25 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Granmar_PS25_DATA_PROCESS'], 'PIS25')}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS25TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Granmar_PS25_TA_25_01','Granmar_PS25_TA_25_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS25 = (ws, message) => {
    if (message.toString() === 'subscribeGRANMPS25'){
    ...
    } else if (message.toString() === 'unsubscribeGRANMPS25'){

...
const { generarTags, generarTagsTCP, arregloTagsPS34Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS34 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS34'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS34TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS34_TA_34_01','RioNilo_FRNL_PS34_TA_34_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS34 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS34'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS34'){

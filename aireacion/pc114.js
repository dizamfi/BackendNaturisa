...
const { generarTags, generarTagsTCP, arregloTagsPC114Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPC114 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PC114'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPC114TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PC114_TA_114_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPC114 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPC114'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPC114'){

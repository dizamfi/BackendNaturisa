...
const { generarTags, generarTagsTCP, arregloTagsPS28Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS28 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS28'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS28TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS28_TA_28_01','RioNilo_FRNL_PS28_TA_28_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS28 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS28'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS28'){

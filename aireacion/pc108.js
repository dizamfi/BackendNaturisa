...
const { generarTags, generarTagsTCP, arregloTagsPC108Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPC108 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PC108'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPC108TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PC108_TA_108_01'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPC108 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPC108'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPC108'){

...
const { arregloTagsPS12Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS12 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS12'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS12TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS12_TA01','Rnl_Sur_PS12_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS12 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS12'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS12'){

...
const { arregloTagsPS09Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS09 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS09'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS09TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS09_TA01','Rnl_Sur_PS09_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS09 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS09'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS09'){

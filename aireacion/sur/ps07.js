...
const { arregloTagsPS07Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS07 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS07'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS07TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS07_TA01','Rnl_Sur_PS07_TA02','Rnl_Sur_PS07_TA03'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS07 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS07'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS07'){

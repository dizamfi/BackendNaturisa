...
const { arregloTagsPS04Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS04 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS04'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS04TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS04_TA01','Rnl_Sur_PS04_TA02','Rnl_Sur_PS04_TA03'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS04 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS04'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS04'){

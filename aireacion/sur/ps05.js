...
const { arregloTagsPS05Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS05 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS05'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS05TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS05_TA01','Rnl_Sur_PS05_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS05 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS05'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS05'){

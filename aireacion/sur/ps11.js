...
const { arregloTagsPS11Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS11 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS11'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS11TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS11_TA01','Rnl_Sur_PS11_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS11 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS11'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS11'){

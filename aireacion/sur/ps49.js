...
const { arregloTagsPS49Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS49 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS49'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS49TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS49_TA01','Rnl_Sur_PS49_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS49 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS49'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS49'){

...
const { arregloTagsPS08Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS08 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS08'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS08TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS08_TA01','Rnl_Sur_PS08_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS08 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS08'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS08'){

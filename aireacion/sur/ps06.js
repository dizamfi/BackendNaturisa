...
const { arregloTagsPS06Antenas, generarTagsSur, generarTagsTCPSur } = require('../../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS06 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsSur(['Rnl_Sur_PS06'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS06TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCPSur(['Rnl_Sur_PS06_TA01','Rnl_Sur_PS06_TA02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS06 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLSPS06'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLSPS06'){

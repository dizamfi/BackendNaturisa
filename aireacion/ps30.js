...
const { generarTags, generarTagsTCP, arregloTagsPS30Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS30 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS30'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS30TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS30_TA_30_01','RioNilo_FRNL_PS30_TA_30_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS30 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS30'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS30'){

...
const { generarTags, generarTagsTCP, arregloTagsPS35Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS35 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS35'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS35TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS35_TA_35_01','RioNilo_FRNL_PS35_TA_35_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS35 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS35'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS35'){

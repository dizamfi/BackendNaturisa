...
const { generarTags, generarTagsTCP, arregloTagsPS40Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS40 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS40'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS40TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS40_TA_40_01','RioNilo_FRNL_PS40_TA_40_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS40 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS40'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS40'){

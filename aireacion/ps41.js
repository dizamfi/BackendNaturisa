...
const { generarTags, generarTagsTCP, arregloTagsPS41Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS41 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS41'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS41TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS41_TA_41_01','RioNilo_FRNL_PS41_TA_41_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS41 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS41'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS41'){

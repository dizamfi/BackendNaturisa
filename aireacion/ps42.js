...
const { generarTags, generarTagsTCP, arregloTagsPS42Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS42 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS42'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS42TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS42_TA_42_01','RioNilo_FRNL_PS42_TA_42_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS42 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS42'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS42'){

...
const { generarTags, generarTagsTCP, arregloTagsPS38Antenas } = require('../../../helpers/rioNilo/arregloTagsAireacion');
...
const getPS38 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['RioNilo_FRNL_PS38'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS38TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['RioNilo_FRNL_PS38_TA_38_01','RioNilo_FRNL_PS38_TA_38_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS38 = (ws, message) => {
    if (message.toString() === 'subscribeFRNLPS38'){
    ...
    } else if (message.toString() === 'unsubscribeFRNLPS38'){

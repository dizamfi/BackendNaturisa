...
const { arregloTagsAntenasAllNaturisa, arregloTagsInfoGeneralPSNaturisa } = require('../../../helpers/naturisa/arregloTagsAireacion');
...
const getInfoGeneralPSNaturisa = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${arregloTagsInfoGeneralPSNaturisa()}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const executeAllFuntions = () => {
    getInfoGeneralPSNaturisa(),
    getAntenasAllNaturisa()
}

const handleSubscriptionInfoGeneralPSFNTS = (ws, message) => {
    if (message.toString() === 'subscribeFNTSInfoGeneralPS'){
    ...
    } else if (message.toString() === 'unsubscribeFNTSInfoGeneralPS'){
...
module.exports = { handleSubscriptionInfoGeneralPSFNTS }

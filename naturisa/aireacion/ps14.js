...
const { generarTags, generarTagsTCP, arregloTagsPS14Antenas } = require('../../../helpers/naturisa/arregloTagsAireacion');
...
const getPS14 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Naturisa_FNTS_PS14'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS14TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Naturisa_FNTS_PS14_TA_14_01','Naturisa_FNTS_PS14_TA_14_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS14 = (ws, message) => {
    if (message.toString() === 'subscribeFNTSPS14'){
    ...
    } else if (message.toString() === 'unsubscribeFNTSPS14'){

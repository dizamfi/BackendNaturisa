...
const { generarTags, generarTagsTCP, arregloTagsPS51Antenas } = require('../../../helpers/maricultura/arregloTagsAireacion');
...
const getPS51 = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTags(['Maricultura_FMARC_PS51'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
...
const getPS51TCP = () => {
    try {
        let client = net.connect('\\\\.\\pipe\\HmiRuntime', () => {
            let tagReadCommand = `{"Message":"ReadTag","Params":{"Tags": ${generarTagsTCP(['Maricultura_FMARC_PS51_TA_51_01','Maricultura_FMARC_PS51_TA_51_02'])}},"ClientCookie":"myReadTagRequest1"}\n`;
            let obje = {};
            client.write(tagReadCommand);
...
const handleSubscriptionPS51 = (ws, message) => {
    if (message.toString() === 'subscribeFMARCPS51'){
    ...
    } else if (message.toString() === 'unsubscribeFMARCPS51'){
